    ...
    <div class="container pt-10">
        <div class="banner">
            <div class="d-flex flex-wrap main-banner">
                <div class="col-lg-5 col-12 banner-desc d-flex flex-column justify-content-center align-items-start">
                ...
                <div class="col-lg-7 col-12 d-flex align-items-center">
                    <div class="banner-video">
                        <video id="vidTrailer" ref="vidTrailer">
                            ...
                            <source src="../assets/trainer.mp4" type="video/ogg">
                            Your browser does not support HTML video.
                        </video>
                        <div class="d-flex justify-content-center align-items-center banner-video-play-btn" @click="playVideoo()">
                            <img src="../assets/play-button-arrowhead.png" alt="">
                            <p>Video Trailer</p>
                        </div>
                    </div>
                </div>
